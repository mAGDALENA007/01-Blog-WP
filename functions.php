<?php
/**
 * BlogTheme functions and definitions
 *
...
if ( ! function_exists( 'blog_theme_setup' ) ) :
	...
	function blog_theme_setup() {
		 ...
		 * If you're building a theme based on BlogTheme, use a find and replace
...
function blog_theme_scripts() {
	...
	wp_enqueue_script( 'blog_theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
...
function new_excerpt_more($more) {
    global $post;
	return '... <a class="moretag" href="'. get_permalink($post->ID) . '"> kontynuuj czytanie &raquo;</a>';
}
